---
title: ""  
author: "<img src='`r read.dcf('DESCRIPTION', fields = 'URL')[1]`/raw/`r gsub('[*] ','',system('git config --global --add safe.directory \'*\' git branch', intern = TRUE)[1])`/inst/hex/hex.png' height='300'><br><br>
